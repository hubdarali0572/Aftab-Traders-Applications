    ...
    <AuthenticatedLayout>
        ...
        <div class="max-w-8xl mx-auto mb-8 flex justify-between items-center">
            ...
            <div class="flex gap-3">
                <Link :href="route('expenses.edit', expense.id)" class="theme-btn-primary px-6 py-2">{{ $t('Edit') }}</Link>
                <Link :href="route('expenses.index')" class="theme-form-back-link">{{ $t('Back') }}</Link>
            </div>
        </div>
        ...
        <div class="space-y-6">
            ...
            <div class="theme-form-card p-10">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div>
                        <dt class="text-xs font-bold text-slate-400 uppercase">{{ $t('Expense No') }}</dt>
                        <dd class="font-bold text-indigo-600 mt-1">{{ expense.expense_no }}</dd>
                    </div>
                    <div>
                        <dt class="text-xs font-bold text-slate-400 uppercase">{{ $t('Date') }}</dt>
                    ...
                    <div>
                        <dt class="text-xs font-bold text-slate-400 uppercase">{{ $t('Expense Head') }}</dt>
