    ...
    <AuthenticatedLayout>
        ...
        <div class="max-w-8xl mx-auto mb-8 flex justify-between items-center">
            ...
            <div class="flex gap-3">
                <Link :href="route('expense-heads.edit', expenseHead.id)" class="theme-btn-primary px-6 py-2">Edit</Link>
                <Link :href="route('expense-heads.index')" class="theme-form-back-link">Back</Link>
            </div>
        </div>
        ...
        <div class="space-y-6">
            <div class="theme-form-card p-10">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                    <div>
                        <dt class="text-xs font-bold text-slate-400 uppercase">Head Code</dt>
                        <dd class="font-bold text-indigo-600 mt-1">{{ expenseHead.head_code }}</dd>
                    </div>
                    <div>
                        <dt class="text-xs font-bold text-slate-400 uppercase">Name</dt>
                    ...
                    <div>
                        <dt class="text-xs font-bold text-slate-400 uppercase">Linked Expenses</dt>
