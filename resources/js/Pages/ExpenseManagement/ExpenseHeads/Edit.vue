...
<template>
    <Head title="Edit Expense Head" />

    <AuthenticatedLayout>
        <div class="max-w-8xl mx-auto mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
                <h2 class="text-2xl font-extrabold text-slate-900 tracking-tight dark:text-slate-100">Edit Expense Head</h2>
                <p class="text-sm text-slate-800 mt-1 font-medium dark:text-slate-400">Update existing expense head details.</p>
            </div>
