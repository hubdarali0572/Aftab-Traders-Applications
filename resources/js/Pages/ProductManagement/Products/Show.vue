...
<template>
    ...
    <AuthenticatedLayout>
        <div class="max-w-8xl mx-auto mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <div class="flex items-center gap-3">
                ...
                <Link :href="route('products.index')" class="theme-form-back-link">
                    ...
                    <span class="text-slate-900">Back to Product List</span>
                </Link>
            </div>
        </div>
        ...
        <div class="max-w-8xl mx-auto pb-24 space-y-6">
            <div class="theme-form-card">
                <div class="p-8 md:p-10">
                    <div class="flex flex-wrap items-center gap-3 mb-8">
                        ...
                        <span v-if="product.track_stock" class="px-3 py-1.5 rounded-full text-xs font-black uppercase tracking-widest bg-indigo-100 text-indigo-700 dark:bg-indigo-900/40 dark:text-indigo-300">Tracked</span>
                        <span v-if="product.has_expiry" class="px-3 py-1.5 rounded-full text-xs font-black uppercase tracking-widest bg-amber-100 text-amber-700 dark:bg-amber-900/40 dark:text-amber-300">Has Expiry</span>
                        <span v-if="product.is_serialized" class="px-3 py-1.5 rounded-full text-xs font-black uppercase tracking-widest bg-sky-100 text-sky-700 dark:bg-sky-900/40 dark:text-sky-300">Serialized</span>
                    </div>
                    ...
                    <dl class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-10 gap-y-6">
                        ...
                        <div>
                            <dt class="text-xs font-bold uppercase tracking-widest text-slate-400">Slug</dt>
                        ...
                        <div>
                            <dt class="text-xs font-bold uppercase tracking-widest text-slate-400">Barcode</dt>
                            <dd class="mt-1 text-sm font-semibold text-slate-600 dark:text-slate-300">{{ fmt(product.barcode) }}</dd>
                        </div>
                        <div>
                            <dt class="text-xs font-bold uppercase tracking-widest text-slate-400">Category</dt>
                            <dd class="mt-1 text-sm font-semibold text-slate-600 dark:text-slate-300">{{ fmt(product.category?.name) }}</dd>
                        </div>
                        <div>
                            <dt class="text-xs font-bold uppercase tracking-widest text-slate-400">Brand</dt>
                            <dd class="mt-1 text-sm font-semibold text-slate-600 dark:text-slate-300">{{ fmt(product.brand?.name) }}</dd>
                        </div>
                        <div>
                            <dt class="text-xs font-bold uppercase tracking-widest text-slate-400">Unit</dt>
                        ...
                        <div>
                            <dt class="text-xs font-bold uppercase tracking-widest text-slate-400">Tax</dt>
            ...
            <div class="theme-form-card">
                <div class="p-8 md:p-10">
                    <h3 class="text-sm font-black uppercase tracking-widest text-slate-500 dark:text-slate-400 mb-6">Product Details</h3>
                    <dl class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-10 gap-y-6">
                        <div>
                            <dt class="text-xs font-bold uppercase tracking-widest text-slate-400">Model Number</dt>
                            <dd class="mt-1 text-sm font-semibold text-slate-600 dark:text-slate-300">{{ fmt(product.model_number) }}</dd>
                        </div>
                        <div>
                            <dt class="text-xs font-bold uppercase tracking-widest text-slate-400">Manufacturer</dt>
                            <dd class="mt-1 text-sm font-semibold text-slate-600 dark:text-slate-300">{{ fmt(product.manufacturer) }}</dd>
                        </div>
                        <div>
                            <dt class="text-xs font-bold uppercase tracking-widest text-slate-400">Color</dt>
                            <dd class="mt-1 text-sm font-semibold text-slate-600 dark:text-slate-300">{{ fmt(product.color) }}</dd>
                        </div>
                        <div>
                            <dt class="text-xs font-bold uppercase tracking-widest text-slate-400">Size</dt>
                            <dd class="mt-1 text-sm font-semibold text-slate-600 dark:text-slate-300">{{ fmt(product.size) }}</dd>
                        </div>
                        <div>
                            <dt class="text-xs font-bold uppercase tracking-widest text-slate-400">Weight</dt>
                            <dd class="mt-1 text-sm font-semibold text-slate-600 dark:text-slate-300">{{ fmtNumber(product.weight, ' kg') }}</dd>
                        </div>
                        <div>
                            <dt class="text-xs font-bold uppercase tracking-widest text-slate-400">HSN Code</dt>
                            <dd class="mt-1 text-sm font-semibold text-slate-600 dark:text-slate-300">{{ fmt(product.hsn_code) }}</dd>
                        </div>
                        <div>
                            <dt class="text-xs font-bold uppercase tracking-widest text-slate-400">Origin Country</dt>
                            <dd class="mt-1 text-sm font-semibold text-slate-600 dark:text-slate-300">{{ fmt(product.origin_country) }}</dd>
                        </div>
                        <div class="md:col-span-2 lg:col-span-3">
                            <dt class="text-xs font-bold uppercase tracking-widest text-slate-400">Description</dt>
            ...
            <div class="theme-form-card">
                <div class="p-8 md:p-10">
                    <h3 class="text-sm font-black uppercase tracking-widest text-slate-500 dark:text-slate-400 mb-6">Stock Settings</h3>
                    <dl class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-10 gap-y-6">
                        <div>
                        ...
                        <div>
                            <dt class="text-xs font-bold uppercase tracking-widest text-slate-400">Track Stock</dt>
                            <dd class="mt-1">
                        ...
                        <div>
                            <dt class="text-xs font-bold uppercase tracking-widest text-slate-400">Has Expiry</dt>
                            <dd class="mt-1">
                        ...
                        <div>
                            <dt class="text-xs font-bold uppercase tracking-widest text-slate-400">Is Serialized</dt>
                            <dd class="mt-1">
            ...
            <div class="theme-form-card">
                <div class="p-8 md:p-10">
                    ...
                    <dl class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-10 gap-y-6">
                        ...
                        <div>
                            <dt class="text-xs font-bold uppercase tracking-widest text-slate-400">Product ID</dt>
