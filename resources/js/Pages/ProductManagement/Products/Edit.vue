...
<template>
    ...
    <AuthenticatedLayout>
        <div class="max-w-8xl mx-auto mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
                <h2 class="text-2xl font-extrabold text-slate-900 tracking-tight dark:text-slate-100">Edit Product</h2>
            </div>
            ...
            <form @submit.prevent="submit" class="space-y-3">
                <div class="theme-form-card">
                    <div class="p-8 md:p-10">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-3">
                            ...
                            <div class="flex flex-col">
                                <div class="flex items-center justify-between ml-1">
                                    <InputLabel for="slug" value="Slug" class="theme-form-label" />
                                    <button type="button" @click="regenerateSlug" class="text-xs font-bold text-indigo-600 hover:text-indigo-700 dark:text-indigo-400">Regenerate</button>
                                </div>
                            ...
                            <div class="flex flex-col">
                                <InputLabel for="sku" value="SKU" class="theme-form-label ml-1" />
                            ...
                            <div class="flex flex-col">
                                <InputLabel for="barcode" value="Barcode" class="theme-form-label ml-1" />
                            ...
                            <div class="flex flex-col">
                                <InputLabel for="product_category_id" value="Category" class="theme-form-label ml-1" />
                            ...
                            <div class="flex flex-col">
                                <InputLabel for="brand_id" value="Brand" class="theme-form-label ml-1" />
                            ...
                            <div class="flex flex-col">
                                <InputLabel for="unit_id" value="Unit" class="theme-form-label ml-1" />
                        ...
                        <h3 class="text-sm font-black uppercase tracking-widest text-slate-500 dark:text-slate-400 mt-10 mb-6">Product Details</h3>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-8">
                            <div class="flex flex-col">
                                <InputLabel for="model_number" value="Model Number" class="theme-form-label ml-1" />
                            ...
                            <div class="flex flex-col">
                                <InputLabel for="manufacturer" value="Manufacturer" class="theme-form-label ml-1" />
                            ...
                            <div class="flex flex-col">
                                <InputLabel for="color" value="Color" class="theme-form-label ml-1" />
                            ...
                            <div class="flex flex-col">
                                <InputLabel for="size" value="Size" class="theme-form-label ml-1" />
                            ...
                            <div class="flex flex-col">
                                <InputLabel for="hsn_code" value="HSN Code" class="theme-form-label ml-1" />
                            ...
                            <div class="flex flex-col  md:col-span-2">
                                <InputLabel for="origin_country" value="Origin Country" class="theme-form-label ml-1" />
                        ...
                        <h3 class="text-sm font-black uppercase tracking-widest text-slate-500 dark:text-slate-400 mt-10 mb-6">Stock Settings</h3>
                       <div class="space-y-8">
                            <!-- Stock Numbers -->
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-8">
                                <div class="flex flex-col">
                                    <InputLabel for="minimum_stock" value="Minimum Stock" class="theme-form-label ml-1" />
                                ...
                                <div class="flex flex-col">
                                    <InputLabel for="maximum_stock" value="Maximum Stock" class="theme-form-label ml-1" />
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-4 gap-x-10 gap-y-8">
                                <div class="flex flex-col">
                                    <InputLabel value="Track Stock" class="theme-form-label ml-1" />
                                ...
                                <div class="flex flex-col">
                                    <InputLabel value="Has Expiry" class="theme-form-label ml-1" />
                                    <label class="inline-flex items-center gap-3 mt-2 cursor-pointer select-none">
                                ...
                                <div class="flex flex-col">
                                    <InputLabel value="Is Serialized" class="theme-form-label ml-1" />
                                    <label class="inline-flex items-center gap-3 mt-2 cursor-pointer select-none">
                ...
                <div class="flex items-center justify-center pt-4">
                    <PrimaryButton class="theme-btn-primary px-12 py-4 rounded-full text-white font-black text-xs uppercase tracking-widest active:scale-95" :class="{ 'opacity-50 cursor-not-allowed': form.processing }" :disabled="form.processing">Update Product</PrimaryButton>
                </div>
            </form>
        </div>
    </AuthenticatedLayout>
