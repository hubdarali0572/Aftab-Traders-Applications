...
const form = useForm({
    ...
    carton_qty: props.product.carton_qty ?? '',
    price_per_carton: props.product.price_per_carton ?? '',
    pieces_per_carton: props.product.pieces_per_carton ?? '',
    price_per_piece: props.product.price_per_piece ?? 0,
