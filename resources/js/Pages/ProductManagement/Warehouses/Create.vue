...
<template>
    ...
    <AuthenticatedLayout>
        <div class="max-w-8xl mx-auto mb-4 flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
                <h2 class="text-2xl font-extrabold text-slate-900 tracking-tight dark:text-slate-100">Create New Warehouse</h2>
            </div>
            ...
            <form @submit.prevent="submit" class="space-y-3">
                <div class="theme-form-card">
                    <div class="p-8 md:p-10">
                        ...
                        <h3 class="text-sm font-black uppercase tracking-widest text-slate-500 dark:text-slate-400 mt-10 mb-6">Contact Information</h3>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-8">
                            <div class="flex flex-col">
                                <InputLabel for="contact_person" value="Contact Person" class="theme-form-label ml-1" />
                            ...
                            <div class="flex flex-col">
                                <InputLabel for="phone" value="Phone" class="theme-form-label ml-1" />
                            ...
                            <div class="flex flex-col md:col-span-2">
                                <InputLabel for="email" value="Email" class="theme-form-label ml-1" />
                        ...
                        <h3 class="text-sm font-black uppercase tracking-widest text-slate-500 dark:text-slate-400 mt-10 mb-6">Location</h3>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-8">
                            <div class="flex flex-col">
                                <InputLabel for="city" value="City" class="theme-form-label ml-1" />
                            ...
                            <div class="flex flex-col">
                                <InputLabel for="address" value="Address" class="theme-form-label ml-1" />
                        ...
                        <h3 class="text-sm font-black uppercase tracking-widest text-slate-500 dark:text-slate-400 mt-10 mb-6">Settings</h3>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-8">
                            <div class="flex flex-col">
                                <InputLabel value="Default Warehouse" class="theme-form-label ml-1" />
                ...
                <div class="flex items-center justify-center pt-4">
                    <PrimaryButton class="theme-btn-primary px-12 py-4 rounded-full text-white font-black text-xs uppercase tracking-widest active:scale-95" :class="{ 'opacity-50 cursor-not-allowed': form.processing }" :disabled="form.processing">Create Warehouse</PrimaryButton>
                </div>
            </form>
        </div>
    </AuthenticatedLayout>
