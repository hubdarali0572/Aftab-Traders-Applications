...
<template>
    <AuthenticatedLayout>
        <Head title="Edit Opening Stock" />
        <div class="max-w-8xl mx-auto mb-5 flex justify-between items-center">
            <h2 class="text-2xl font-extrabold text-slate-900 dark:text-white">Edit Opening Stock</h2>
        ...
        <form @submit.prevent="submit" class="theme-form-card p-8 md:p-10 space-y-6">
            ...
            <div class="flex justify-center"><PrimaryButton :disabled="form.processing">Update Opening Stock</PrimaryButton></div>
        </form>
    </AuthenticatedLayout>
</template>