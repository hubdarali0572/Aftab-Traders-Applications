...
<template>
    <AuthenticatedLayout>
        <Head title="Purchase Expenses" />

        <div class="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                <h2 class="text-2xl font-black text-slate-700 tracking-tight dark:text-slate-100">Purchase Expenses</h2>
                <p class="text-sm text-slate-500 mt-1 font-medium dark:text-slate-400">Track additional costs linked to purchases.</p>
            </div>
                ...
                <table class="w-full text-left border-collapse">
                    <thead>
                        <tr class="theme-table-header">
                            ...
                            <th class="theme-table-header-cell">Expense Type</th>
                    ...
                    <tbody class="divide-y divide-slate-100 dark:divide-slate-700">
                        ...
                        <tr v-if="expenses.data.length === 0">
                            <td colspan="5" class="px-6 py-12 text-center text-slate-400 font-medium">No purchase expenses found.</td>
                        </tr>
                    </tbody>
                </table>
            </div>
