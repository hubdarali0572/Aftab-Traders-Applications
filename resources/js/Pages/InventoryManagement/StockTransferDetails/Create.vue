...
const props = defineProps({ transfers: Array, products: Array });
...
const submit = () => form.post(route('stock-transfer-details.store'));
</script>

<template>
    <AuthenticatedLayout>
        <Head :title="$t('Add Transfer Item')" />
        <div class="max-w-8xl mx-auto mb-5 flex justify-between items-center">
            <h2 class="text-2xl font-black text-slate-900">{{ $t('Add Transfer Line Item') }}</h2>
