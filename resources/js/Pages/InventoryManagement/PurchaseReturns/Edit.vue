...
<template>
    <AuthenticatedLayout>
        ...
        <div class="max-w-8xl mx-auto mb-5 flex justify-between items-center">
            <h2 class="text-2xl font-black text-slate-800">{{ $t('Edit Purchase Return') }}</h2>
            <Link :href="route('purchase-returns.index')" class="theme-form-back-link font-bold">{{ $t('Back to List') }}</Link>
        </div>
