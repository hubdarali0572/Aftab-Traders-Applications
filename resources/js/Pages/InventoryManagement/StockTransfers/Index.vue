...
<template>
    <AuthenticatedLayout>
        ...
        <div class="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                <h2 class="text-2xl font-black text-slate-700 tracking-tight dark:text-slate-100">Stock Transfers</h2>
                <p class="text-sm text-slate-500 mt-1 font-medium dark:text-slate-400">Move inventory between warehouses.</p>
            </div>
                ...
                <table class="w-full text-left border-collapse">
                    <thead>
                        <tr class="theme-table-header">
                            ...
                            <th class="theme-table-header-cell">From</th>
                            <th class="theme-table-header-cell">To</th>
                            <th class="theme-table-header-cell text-right">Total Qty</th>
                            <th class="theme-table-header-cell text-right">Total Amount</th>
                            <th class="theme-table-header-cell">Stock Status</th>
                    ...
                    <tbody class="divide-y divide-slate-100 dark:divide-slate-700">
                        <tr v-for="t in transfers.data" :key="t.id" class="theme-table-row group">
                            ...
                            <td class="px-6 py-3 text-right whitespace-nowrap">
                                <div class="theme-table-actions">
                                    <Link :href="route('stock-transfers.show', t.id)" class="theme-table-action-btn" title="View">
                                    ...
                                    <Link :href="route('stock-transfers.edit', t.id)" class="theme-table-action-btn theme-table-action-edit" title="Edit">
                                    ...
                                    <button @click="openDeleteModal(t.id)" class="theme-table-action-btn theme-table-action-delete" title="Delete">
                        ...
                        <tr v-if="transfers.data.length === 0">
                            <td colspan="8" class="px-6 py-12 text-center text-slate-400 font-medium dark:text-slate-500">No stock transfer records found.</td>
                        </tr>
                    </tbody>
                </table>
            </div>
