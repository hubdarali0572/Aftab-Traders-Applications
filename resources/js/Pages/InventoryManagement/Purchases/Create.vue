...
<template>
    <AuthenticatedLayout>
        ...
        <div class="max-w-8xl mx-auto mb-5 flex justify-between items-center">
            ...
            <Link :href="route('purchases.index')" class="theme-form-back-link">Back to List</Link>
        </div>
        ...
        <form @submit.prevent="submit" class="theme-form-card p-8 md:p-10 space-y-6">
            ...
            <div class="flex justify-center"><PrimaryButton :disabled="form.processing">Save Purchase</PrimaryButton></div>
        </form>
    </AuthenticatedLayout>
</template>
