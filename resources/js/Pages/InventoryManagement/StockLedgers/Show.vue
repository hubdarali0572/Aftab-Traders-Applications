            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-sm font-semibold text-slate-500 dark:text-slate-400">
                        Reference: <span class="text-indigo-600">{{ fmt(ledger.reference_no) }}</span>
                    </p>
                </div>
            </div>
        ...
        <div class="max-w-8xl mx-auto pb-24 space-y-6">
            ...
            <div class="theme-form-card">
                <div class="p-8 md:p-10">
                    ...
                    <h3 class="text-sm font-black uppercase tracking-widest text-slate-500 mb-6">Transaction Details</h3>
                    <dl class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-10 gap-y-6">
                        <div>
                            <dt class="text-xs font-bold uppercase tracking-widest text-slate-400">Transaction Date</dt>
            ...
            <div class="theme-form-card">
                <div class="p-8 md:p-10">
                    <h3 class="text-sm font-black uppercase tracking-widest text-slate-500 mb-6">Stock Movement</h3>
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div class="bg-emerald-50 dark:bg-emerald-900/10 p-6 rounded-2xl border border-emerald-100 dark:border-emerald-800">
                            <dt class="text-xs font-bold uppercase tracking-widest text-emerald-600">Quantity In</dt>
                        ...
                        <div class="bg-rose-50 dark:bg-rose-900/10 p-6 rounded-2xl border border-rose-100 dark:border-rose-800">
                            <dt class="text-xs font-bold uppercase tracking-widest text-rose-600">Quantity Out</dt>
                        ...
                        <div class="bg-slate-50 dark:bg-slate-700/50 p-6 rounded-2xl border border-slate-200 dark:border-slate-600">
                            <dt class="text-xs font-bold uppercase tracking-widest text-slate-500">Balance After Transaction</dt>
            ...
            <div class="theme-form-card">
                <div class="p-8 md:p-10">
                    <h3 class="text-sm font-black uppercase tracking-widest text-slate-500 mb-6">Cost Information</h3>
                    <dl class="grid grid-cols-1 md:grid-cols-2 gap-10">
                        <div>
                            <dt class="text-xs font-bold uppercase tracking-widest text-slate-400">Unit Cost</dt>
                            <dd class="mt-1 text-lg font-bold text-slate-800 dark:text-slate-100">${{ fmtNumber(ledger.unit_cost) }}</dd>
                        </div>
                        <div>
                            <dt class="text-xs font-bold uppercase tracking-widest text-slate-400">Total Transaction Cost</dt>
