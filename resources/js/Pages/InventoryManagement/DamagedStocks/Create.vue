...
<template>
    <AuthenticatedLayout>
        ...
        <div class="max-w-8xl mx-auto mb-5 flex justify-between items-center">
            <h2 class="text-2xl font-extrabold text-slate-900 dark:text-white">Create Damaged Stock Record</h2>
            <Link :href="route('damaged-stocks.index')" class="theme-form-back-link text-sm font-bold">Back to List</Link>
        </div>
        ...
        <form @submit.prevent="submit" class="theme-form-card p-8 md:p-10 space-y-6">
            ...
            <div class="flex justify-center"><PrimaryButton :disabled="form.processing">Save Damage Record</PrimaryButton></div>
        </form>
    </AuthenticatedLayout>
</template>
