...
<template>
    <AuthenticatedLayout>
        ...
        <div class="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                <h2 class="text-2xl font-black text-slate-700 tracking-tight dark:text-slate-100">Stock Adjustments</h2>
                <p class="text-sm text-slate-500 mt-1 font-medium dark:text-slate-400">Manage and track inventory increases and decreases.</p>
            </div>
                        ...
                        <tr v-for="adj in adjustments.data" :key="adj.id" class="theme-table-row group">
                            ...
                            <td class="px-6 py-3 text-right whitespace-nowrap">
                                <div class="theme-table-actions">
                                    ...
                                    <Link :href="route('stock-adjustments.edit', adj.id)" class="theme-table-action-btn theme-table-action-edit" title="Edit">
                                    ...
                                    <button @click="openDeleteModal(adj.id)" class="theme-table-action-btn theme-table-action-delete" title="Delete">
