...
const props = defineProps({ saleReturns: Array, products: Array, units: Array });
...
const submit = () => form.post(route('sale-return-details.store'));
</script>

<template>
    <AuthenticatedLayout>
        <Head title="Add Sales Return Item" />
        <div class="max-w-8xl mx-auto mb-5 flex justify-between items-center">
            <h2 class="text-2xl font-black text-slate-900">{{ $t('Add Sales Return Line Item') }}</h2>
