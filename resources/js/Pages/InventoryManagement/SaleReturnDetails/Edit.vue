...
<template>
    <AuthenticatedLayout>
        ...
        <div class="max-w-8xl mx-auto mb-5 flex justify-between items-center">
            <h2 class="text-2xl font-black text-slate-900">{{ $t('Edit Sales Return Line Item') }}</h2>
        ...
        <form @submit.prevent="submit" class="theme-form-card p-8 md:p-10 space-y-6">
            ...
            <div class="flex justify-center"><PrimaryButton :disabled="form.processing">{{ $t('Update Item') }}</PrimaryButton></div>
        </form>
    </AuthenticatedLayout>
</template>
