...
const submit = () => {
    form.post(route('warehouse-stocks.store'));
};
</script>

<template>
    <Head title="Add Warehouse Stock" />
    <AuthenticatedLayout>
        <div class="max-w-8xl mx-auto mb-5 flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
                <h2 class="text-2xl font-extrabold text-slate-900 tracking-tight dark:text-slate-100">Add Warehouse Stock Entry</h2>
            </div>
        ...
        <div class="max-w-8xl mx-auto pb-5">
            <form @submit.prevent="submit" class="space-y-4">
                <div class="theme-form-card">
                    <div class="p-8 md:p-10">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-3">
                            ...
                            <div class="flex flex-col">
                                <InputLabel for="reserved_quantity" value="Reserved Quantity" class="theme-form-label ml-1" />
                            ...
                            <div class="flex flex-col">
                                <InputLabel for="average_cost" value="Average Cost" class="theme-form-label ml-1" />
                            ...
                            <div class="flex flex-col">
                                ...
                                <TextInput id="maximum_stock" type="number" step="0.01" class="theme-form-input" v-model="form.maximum_stock" placeholder="Optional" />
                                <InputError :message="form.errors.maximum_stock" class="mt-2 ml-1" />
                            </div>
                            <div class="flex flex-col">
                                <InputLabel for="reorder_level" value="Reorder Level" class="theme-form-label ml-1" />
                            ...
                            <div class="flex flex-col">
                                <InputLabel for="last_received_at" value="Last Received At" class="theme-form-label ml-1" />
                            ...
                            <div class="flex flex-col">
                                <InputLabel for="last_issued_at" value="Last Issued At" class="theme-form-label ml-1" />
                ...
                <div class="flex items-center justify-center pt-4">
                    <PrimaryButton class="theme-btn-primary px-12 py-4 rounded-full text-white font-black text-xs uppercase tracking-widest active:scale-95" :class="{ 'opacity-50 cursor-not-allowed': form.processing }" :disabled="form.processing">Add Stock Entry</PrimaryButton>
                </div>
            </form>
        </div>
    </AuthenticatedLayout>
